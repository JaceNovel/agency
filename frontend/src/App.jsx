          ...
          <div className="sidebar-scroll-cue grid place-items-center text-blue-100"><ChevronDown size={22} /></div>
	          <div className="sidebar-help mt-6 shrink-0 rounded-2xl border border-white/10 bg-blue-600/20 p-5">
	            ...
	            {token ? (
	              ...
	              <Link to="/login" className="message-menu-button mt-4 flex h-11 w-full items-center justify-center gap-3 rounded-lg bg-white text-sm font-black text-blue-800"><span>Se connecter</span></Link>
	            )}
	          </div>
        </div>
      </aside>
